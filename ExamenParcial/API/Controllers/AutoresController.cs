...
namespace API.Controllers
{
    ...
    public class AutoresController : Controller
    {
        ...
        public AutoresController(NDbContext context)
        {
            _context = context;
        }
        // GET: api/Autores
        ...
        // GET: api/Autores/5
        [HttpGet("{id}")]
        public async Task<ActionResult<models.Autores>> GetAutores(string id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutAutores(string id, models.Autores Autores)
        {
            if (id != Autores.Id)
            {
                return BadRequest();
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<models.Autores>> DeleteAutores(string id)
        {
            var Autores = new BE.Autores(_context).GetOneById(id);
            if (Autores == null)
            {
        ...
        private bool AutoresExists(string id)
        {
